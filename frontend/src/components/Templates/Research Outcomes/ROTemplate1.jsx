  ...
  return (
    <div className="container" style={{ maxWidth: "90%", margin: "0 auto" }}>
      <p className="description" style={{ textAlign: "center" }}>
        <strong>LCI-Template XXXXXVIII</strong>
      </p>
      ...
      >
        <div className="column" style={{ width: "100%" }}>
          <label>
            <strong>Expected outcome e.g., product, process, service, training for process accomplishment or composition of matter etc.</strong>
          </label>
          <TextField
