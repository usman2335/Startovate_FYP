    ...
    <div className="how-it-works">
      <div className="contentwrapper">
        <div className="content-left">
          ...
          <p>
            Easily complete your Lean Canvas with guided checklists and
            templates. Create and export your business plan in just a few simple
            steps!
          </p>
          ...
          <div className="row">
            ...
            >
              ...
              <div className="instr-text flex-col">
                ...
                <p>
                  A checklist will guide you through the important aspects of
                  that component.
                </p>
              </div>
            </div>
          ...
          <div className="row">
            ...
            >
              ...
              <div className="instr-text flex-col">
                ...
                <p>
                  Use the checklist to fill out the corresponding template for
                  that component.
                </p>
              </div>
            </div>
          ...
          <div className="row row4">
            ...
            >
              ...
              <div className="instr-text flex-col">
                ...
                <p>
                  Once all components are filled, generate and export your
                  completed Lean Canvas as a Word document
                </p>
              </div>
            </div>
          </div>
