    ...
    <>
      <div className="content-wrapper flex">
        <div className="hero-left">
          <h1>
            Streamline Your Startup Journey with{" "}
            <span className="LC-text">Lean Canvas</span>
          </h1>
          <p>
            Effortlessly create, manage, and refine your Lean Canvas with guided
            templates, AI assistance, and seamless document export – all in one
            platform.
          </p>
          <div className="btn">
            {user?.isSubscribed ? (
